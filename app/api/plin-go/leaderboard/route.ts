...
const sampleUsers = [
  ...
  {
    userId: 'whop_user_4',
    username: 'whop_user_4',
    whopUsername: 'neongamer',
    name: 'NeonGamer',
    balance: 72000,
    wins: 28,
    totalWagered: 500000,
    ...
    level: 3,
    avatar: 'crystal',
    whopAvatarUrl: '/api/plin-go/avatar/whop_user_4',
    lastUpdated: Date.now(),
    isOnline: true,
    lastActivity: Date.now(),
    isPlaying: true
  ...
  {
    userId: 'whop_user_5',
    username: 'whop_user_5',
    whopUsername: 'quantumbet',
    name: 'QuantumBet',
    balance: 65000,
    wins: 25,
    totalWagered: 400000,
    ...
    level: 2,
    avatar: 'whop-elite',
    whopAvatarUrl: '/api/plin-go/avatar/whop_user_5',
    lastUpdated: Date.now(),
    isOnline: true,
    lastActivity: Date.now(),
    isPlaying: true
